...
dofile("script/event/main/main14/080_fuuketsunookatotsunyuu/fuuketsunookatotsunyuu.lua")
function groundInit()
  ...
  SYSTEM:ChangeSazandoraParameterLevel(2)
  subMapCameraDefMode()
...
function EventTriggerIn(symbol)
  ...
  if symbol == "@EXIT" then
    ...
    main14_fuuketsunookatotsunyuu01_start()
    return PROC.OK
  end
