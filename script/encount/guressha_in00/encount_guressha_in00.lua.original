...
function groundInit()
  ...
  if FLAG.EncGuressha_inTryFlag == CONST.FLAG_FALSE then
    ...
    FLAG.EncGuressha_inTryFlag = CONST.FLAG_TRUE
  else
    SYSTEM:SetStatusViewVisible(false)
    CAMERA:SetEye(SymCam("CAMERA_00"))
    CAMERA:SetTgt(SymCam("CAMERA_00"))
...
function encount_guressha_in00_init()
end
function encount_guressha_in00_start()
end
function encount_guressha_in00_end()
end
