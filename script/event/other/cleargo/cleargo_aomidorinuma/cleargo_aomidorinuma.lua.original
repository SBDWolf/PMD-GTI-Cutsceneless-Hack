...
function cleargo_aomidorinuma_hero01_init()
end
function cleargo_aomidorinuma_hero01_start()
  ...
  WINDOW:SwitchTalk({PARTNER_0 = -855737460, PARTNER_1 = -706393395})
  WINDOW:CloseMessage()
  ...
  WINDOW:DrawFace(20, 88, SymAct("PARTNER"), FACE_TYPE.NORMAL)
  WINDOW:SwitchTalk({PARTNER_0 = -20440818, PARTNER_1 = -405591985})
  WINDOW:CloseMessage()
  subEveNod(CH("HERO"))
...
function cleargo_aomidorinuma_hero01_end()
end
function cleargo_aomidorinuma_player01_init()
end
function cleargo_aomidorinuma_player01_start()
  subEveFromProgFadeSet()
  CAMERA:SetAzimuthDifferenceVolume(Volume(4))
  CAMERA:SetEye(SymCam("CAMERA_00"))
  CAMERA:SetTgt(SymCam("CAMERA_00"))
...
function cleargo_aomidorinuma_player01_end()
end
function groundEnd()
end
