...
function cleargo_yoakenosangaku_hero01_init()
end
function cleargo_yoakenosangaku_hero01_start()
  ...
  WINDOW:SwitchTalk({PARTNER_0 = 1418600529, PARTNER_1 = 1301614864})
  WINDOW:CloseMessage()
  ...
  WINDOW:DrawFace(20, 88, SymAct("PARTNER"), FACE_TYPE.NORMAL)
  WINDOW:SwitchTalk({PARTNER_0 = 1723351763, PARTNER_1 = 2141418386})
  WINDOW:CloseMessage()
  subEveNod(CH("HERO"))
...
function cleargo_yoakenosangaku_hero01_end()
end
function cleargo_yoakenosangaku_player01_init()
end
function cleargo_yoakenosangaku_player01_start()
  subEveFromProgFadeSet()
  CAMERA:SetAzimuthDifferenceVolume(Volume(4))
  CAMERA:SetEye(SymCam("CAMERA_00"))
  CAMERA:SetTgt(SymCam("CAMERA_00"))
  ...
  TASK:Sleep(TimeSec(0.3))
  WINDOW:SysMsg(820176213)
  WINDOW:SysMsg(704238612)
  subEveCloseMsg()
  SOUND:FadeOutBgm(TimeSec(1))
  SCREEN_A:FadeOut(TimeSec(1), true)
  SOUND:WaitBgm()
...
function cleargo_yoakenosangaku_player01_end()
end
function groundEnd()
end
