...
function cleargo_sankankaidou_hero01_init()
end
function cleargo_sankankaidou_hero01_start()
  ...
  local taskHeroLookAround = function()
    ...
    CH("HERO"):DirTo(RotateTarget(-80), Speed(350), ROT_TYPE.NEAR)
    CH("HERO"):WaitRotate()
  ...
  WINDOW:SwitchTalk({PARTNER_0 = -658623274, PARTNER_1 = -1046149737})
  WINDOW:CloseMessage()
  ...
  CH("HERO"):WaitRotate()
  WINDOW:DrawFace(20, 88, SymAct("PARTNER"), FACE_TYPE.NORMAL)
  WINDOW:SwitchTalk({PARTNER_0 = -360163756, PARTNER_1 = -208443627})
  WINDOW:CloseMessage()
  subEveNod(CH("HERO"))
...
function cleargo_sankankaidou_hero01_end()
end
function cleargo_sankankaidou_player01_init()
end
function cleargo_sankankaidou_player01_start()
  subEveFromProgFadeSet()
  CAMERA:SetAzimuthDifferenceVolume(Volume(3))
  CAMERA:SetEye(SymCam("CAMERA_00"))
  CAMERA:SetTgt(SymCam("CAMERA_00"))
  ...
  local taskPlayerLookAround = function()
    ...
    TASK:Sleep(TimeSec(0.1))
    CH("PLAYER"):DirTo(RotateTarget(-80), Speed(350), ROT_TYPE.NEAR)
    CH("PLAYER"):WaitRotate()
    TASK:Sleep(TimeSec(0.2))
    CH("PLAYER"):DirTo(RotateTarget(-160), Speed(350), ROT_TYPE.NEAR)
    CH("PLAYER"):WaitRotate()
  ...
  local taskBuddy1LookAround = function()
    CH("BUDDY1"):DirTo(RotateTarget(-60), Speed(350), ROT_TYPE.NEAR)
  ...
  TASK:Sleep(TimeSec(0.3))
  WINDOW:SysMsg(-1127026222)
  WINDOW:SysMsg(-1513504621)
  subEveCloseMsg()
  SOUND:FadeOutBgm(TimeSec(1))
  SCREEN_A:FadeOut(TimeSec(1), true)
  SOUND:WaitBgm()
...
function cleargo_sankankaidou_player01_end()
end
function groundEnd()
end
