...
function cleargo_sekainoheso_hero01_init()
end
function cleargo_sekainoheso_hero01_start()
  ...
  WINDOW:SwitchTalk({PARTNER_0 = -1823755441, PARTNER_1 = -1974435314})
  WINDOW:CloseMessage()
  ...
  WINDOW:DrawFace(20, 88, SymAct("PARTNER"), FACE_TYPE.NORMAL)
  WINDOW:SwitchTalk({PARTNER_0 = -1585589811, PARTNER_1 = -1201217396})
  WINDOW:CloseMessage()
  subEveNod(CH("HERO"))
...
function cleargo_sekainoheso_hero01_end()
end
function cleargo_sekainoheso_player01_init()
end
function cleargo_sekainoheso_player01_start()
  subEveFromProgFadeSet()
  CAMERA:SetEye(SymCam("CAMERA_00"))
  CAMERA:SetTgt(SymCam("CAMERA_00"))
  ...
  TASK:Sleep(TimeSec(0.3))
  WINDOW:SysMsg(-148408757)
  WINDOW:SysMsg(-298039542)
  subEveCloseMsg()
  SOUND:FadeOutBgm(TimeSec(1))
  SCREEN_A:FadeOut(TimeSec(1), true)
  SOUND:WaitBgm()
...
function cleargo_sekainoheso_player01_end()
end
function groundEnd()
end
