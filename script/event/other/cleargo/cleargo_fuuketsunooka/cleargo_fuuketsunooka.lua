...
function cleargo_fuuketsunooka_hero01_init()
end
function cleargo_fuuketsunooka_hero01_start()
  ...
  local taskHeroLookAround = function()
    ...
    CH("HERO"):DirTo(RotateTarget(-20), Speed(350), ROT_TYPE.NEAR)
    CH("HERO"):WaitRotate()
  ...
  WINDOW:SwitchTalk({PARTNER_0 = -1693541982, PARTNER_1 = -2112509725})
  WINDOW:CloseMessage()
  ...
  WINDOW:DrawFace(20, 88, SymAct("PARTNER"), FACE_TYPE.NORMAL)
  WINDOW:SwitchTalk({PARTNER_0 = -1455883488, PARTNER_1 = -1339831711})
  WINDOW:CloseMessage()
  subEveNod(CH("HERO"))
...
function cleargo_fuuketsunooka_hero01_end()
end
function cleargo_fuuketsunooka_player01_init()
end
function cleargo_fuuketsunooka_player01_start()
  subEveFromProgFadeSet()
  CAMERA:SetAzimuthDifferenceVolume(Volume(4))
  CAMERA:SetEye(SymCam("CAMERA_01"))
  CAMERA:SetTgt(SymCam("CAMERA_01"))
  ...
  local taskPlayerLookAround = function()
    CH("PLAYER"):DirTo(RotateTarget(-60), Speed(350), ROT_TYPE.NEAR)
    CH("PLAYER"):WaitRotate()
    TASK:Sleep(TimeSec(0.1))
    CH("PLAYER"):DirTo(RotateTarget(-20), Speed(350), ROT_TYPE.NEAR)
    CH("PLAYER"):WaitRotate()
    TASK:Sleep(TimeSec(0.2))
    CH("PLAYER"):DirTo(RotateTarget(-60), Speed(350), ROT_TYPE.NEAR)
    CH("PLAYER"):WaitRotate()
  ...
  local taskBuddy1LookAround = function()
    ...
    TASK:Sleep(TimeSec(0.2))
    CH("BUDDY1"):DirTo(RotateTarget(160), Speed(350), ROT_TYPE.NEAR)
    CH("BUDDY1"):WaitRotate()
    TASK:Sleep(TimeSec(0.1))
  ...
  TASK:Sleep(TimeSec(0.3))
  CAMERA:WaitMove()
  WINDOW:SysMsg(-10330970)
  WINDOW:SysMsg(-428249625)
  subEveCloseMsg()
  SOUND:FadeOutBgm(TimeSec(1))
  SCREEN_A:FadeOut(TimeSec(1), true)
  SOUND:WaitBgm()
...
function cleargo_fuuketsunooka_player01_end()
end
function groundEnd()
end
