...
function cleargo_kageroutouge_hero01_init()
end
function cleargo_kageroutouge_hero01_start()
  ...
  local taskBuddy2LookAround = function()
    CH("BUDDY2"):DirTo(RotateTarget(30), Speed(350), ROT_TYPE.NEAR)
  ...
  WINDOW:SwitchTalk({PARTNER_0 = -377631667, PARTNER_1 = -261686004})
  WINDOW:CloseMessage()
  ...
  WINDOW:DrawFace(20, 88, SymAct("PARTNER"), FACE_TYPE.NORMAL)
  WINDOW:SwitchTalk({PARTNER_0 = -615797041, PARTNER_1 = -1034903666})
  WINDOW:CloseMessage()
  subEveNod(CH("HERO"))
...
function cleargo_kageroutouge_hero01_end()
end
function cleargo_kageroutouge_player01_init()
end
function cleargo_kageroutouge_player01_start()
  subEveFromProgFadeSet()
  CAMERA:SetAzimuthDifferenceVolume(Volume(6))
  CAMERA:SetEye(SymCam("CAMERA_00"))
  CAMERA:SetTgt(SymCam("CAMERA_00"))
  ...
  TASK:Sleep(TimeSec(0.3))
  WINDOW:SysMsg(-1928263351)
  WINDOW:SysMsg(-1811269624)
  subEveCloseMsg()
  SOUND:FadeOutBgm(TimeSec(1))
  SCREEN_A:FadeOut(TimeSec(1), true)
  SOUND:WaitBgm()
...
function cleargo_kageroutouge_player01_end()
end
function groundEnd()
end
