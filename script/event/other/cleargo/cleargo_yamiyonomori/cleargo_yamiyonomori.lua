...
function cleargo_yamiyonomori_hero01_init()
end
function cleargo_yamiyonomori_hero01_start()
  subEveFromProgFadeSet()
  MAP:ChangeLightColor(Color(0.8, 0.8, 0.8, 1), TimeSec(0))
  ...
  WINDOW:SwitchTalk({PARTNER_0 = 905456991, PARTNER_1 = 753081374})
  WINDOW:CloseMessage()
  ...
  WINDOW:DrawFace(20, 88, SymAct("PARTNER"), FACE_TYPE.NORMAL)
  WINDOW:SwitchTalk({PARTNER_0 = 130961373, PARTNER_1 = 517308060})
  WINDOW:CloseMessage()
  subEveNod(CH("HERO"))
...
function cleargo_yamiyonomori_hero01_end()
end
function cleargo_yamiyonomori_player01_init()
end
function cleargo_yamiyonomori_player01_start()
  subEveFromProgFadeSet()
  MAP:ChangeLightColor(Color(0.8, 0.8, 0.8, 1), TimeSec(0))
  EFFECT:SetSpotFilter(1)
  CAMERA:SetAzimuthDifferenceVolume(Volume(4))
  ...
  TASK:Sleep(TimeSec(0.3))
  WINDOW:SysMsg(1368713307)
  WINDOW:SysMsg(1217386778)
  subEveCloseMsg()
  SOUND:FadeOutBgm(TimeSec(1))
  SCREEN_A:FadeOut(TimeSec(1), true)
  SOUND:WaitBgm()
...
function cleargo_yamiyonomori_player01_end()
end
function groundEnd()
end
