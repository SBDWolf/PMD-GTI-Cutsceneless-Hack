...
function cleargo_doukokunotani_hero01_init()
end
function cleargo_doukokunotani_hero01_start()
  ...
  WINDOW:SwitchTalk({PARTNER_0 = 1067779397, PARTNER_1 = 649999364})
  WINDOW:CloseMessage()
  ...
  WINDOW:DrawFace(20, 88, SymAct("PARTNER"), FACE_TYPE.NORMAL)
  WINDOW:SwitchTalk({PARTNER_0 = 227764167, PARTNER_1 = 344479366})
  WINDOW:CloseMessage()
  subEveNod(CH("HERO"))
...
function cleargo_doukokunotani_hero01_end()
end
function cleargo_doukokunotani_player01_init()
end
function cleargo_doukokunotani_player01_start()
  subEveFromProgFadeSet()
  CAMERA:SetAzimuthDifferenceVolume(Volume(4))
  CAMERA:SetEye(SymCam("CAMERA_00"))
  CAMERA:SetTgt(SymCam("CAMERA_00"))
  ...
  TASK:Sleep(TimeSec(0.3))
  WINDOW:SysMsg(1539948609)
  WINDOW:SysMsg(1121120512)
  subEveCloseMsg()
  SOUND:FadeOutBgm(TimeSec(1))
  SCREEN_A:FadeOut(TimeSec(1), true)
  SOUND:WaitBgm()
...
function cleargo_doukokunotani_player01_end()
end
function groundEnd()
end
