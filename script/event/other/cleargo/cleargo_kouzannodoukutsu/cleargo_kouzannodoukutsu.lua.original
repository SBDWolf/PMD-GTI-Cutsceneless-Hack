...
function cleargo_kouzannodoukutsu_hero01_init()
end
function cleargo_kouzannodoukutsu_hero01_start()
  ...
  SOUND:PlayBgm(SymSnd("SE_EVT_CRYSTAL_SHINE_LP"), Volume(128))
  ...
  WINDOW:SwitchTalk({PARTNER_0 = 2037857412, PARTNER_1 = 1617694149})
  WINDOW:CloseMessage()
  ...
  CH("HERO"):WaitRotate()
  WINDOW:DrawFace(20, 88, SymAct("PARTNER"), FACE_TYPE.NORMAL)
  WINDOW:SwitchTalk({PARTNER_0 = 1262575110, PARTNER_1 = 1381658439})
  WINDOW:CloseMessage()
  subEveNod(CH("HERO"))
...
function cleargo_kouzannodoukutsu_hero01_end()
end
function cleargo_kouzannodoukutsu_player01_init()
end
function cleargo_kouzannodoukutsu_player01_start()
  subEveFromProgFadeSet()
  CAMERA:SetAzimuthDifferenceVolume(Volume(4))
  CAMERA:SetEye(SymCam("CAMERA_00"))
  CAMERA:SetTgt(SymCam("CAMERA_00"))
  ...
  TASK:Sleep(TimeSec(0.3))
  WINDOW:SysMsg(488372608)
  WINDOW:SysMsg(67160257)
  subEveCloseMsg()
  SOUND:FadeOutBgm(TimeSec(1))
  SCREEN_A:FadeOut(TimeSec(1), true)
  SOUND:WaitBgm()
...
function cleargo_kouzannodoukutsu_player01_end()
end
function groundEnd()
end
