...
function main03_arehatedaniboss1st01_start()
  ...
  local taskNokotchiBack = function()
    CH("NOKOTCHI"):DirTo(RotateTarget(180), Speed(10), ROT_TYPE.NEAR)
  ...
  -- CH("HERO"):WaitMove()
  TASK:Sleep(TimeSec(1))
  CH("DOKKORAA_2"):DirTo(CH("DENCHURA_2"), Speed(0), ROT_TYPE.NEAR)
  CH("DOKKORAA_1"):DirTo(CH("DENCHURA_1"), Speed(0), ROT_TYPE.NEAR)


  CH("NOKOTCHI"):DirTo(RotateTarget(45), Speed(0), ROT_TYPE.NEAR)
  CH("EMONGA"):DirTo(RotateTarget(-90), Speed(0), ROT_TYPE.NEAR)
  CH("KOMATANA_2"):DirTo(CH("EMONGA"), Speed(0), ROT_TYPE.NEAR)
  CH("KOMATANA_1"):DirTo(CH("BIRIJION"), Speed(0), ROT_TYPE.NEAR)
  ...
  CH("PARTNER"):DirTo(CH("FUSHIDE_1"), Speed(0), ROT_TYPE.NEAR)
  CH("HERO"):DirTo(CH("FUSHIDE_2"), Speed(0), ROT_TYPE.NEAR)
  CH("BIRIJION"):DirTo(CH("KOMATANA_1"), Speed(0), ROT_TYPE.NEAR)
