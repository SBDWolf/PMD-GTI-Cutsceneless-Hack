...
function main16_chimyakuairototsunyuu01_start()
  ...
  local __LB_SCOPE = function()
    ...
    function __scopeFuncTbl.CELECT_EVENT01()
      WINDOW:SysMsg(20281189)
      local __labelCnt = 0
      local __labelTbl = {}
      WINDOW:SelectStart()
      WINDOW:SelectChain(405685796, __labelCnt)
      __labelTbl[__labelCnt] = __scopeFuncTbl.LABEL_YES
      __labelCnt = __labelCnt + 1
      WINDOW:SelectChain(855840231, __labelCnt)
