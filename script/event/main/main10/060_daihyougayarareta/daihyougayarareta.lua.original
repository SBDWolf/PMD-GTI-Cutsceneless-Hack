...
function main10_daihyougayarareta01_init()
  if FLAG.NowResumeFlag == CONST.FLAG_TRUE then
    ...
    subSaveflagM10_060_01()
    SYSTEM:NextEntry(KEEP_PLACEMENT.ON)
  end
end
function main10_daihyougayarareta01_start()
  subEveFromProgFadeSet()
  subComSaveCompulFailed()
  subEveFadeAfterTime()
  WINDOW:DrawFace(20, 88, SymAct("PARTNER"), FACE_TYPE.PAIN)
  WINDOW:SwitchTalk({PARTNER_0 = 1451779325, PARTNER_1 = 1335055804})
  WINDOW:KeyWait()
  ...
  SOUND:PlayBgm(SymSnd("BGM_DUN_13"), Volume(256))
  subEveFadeAfterTime()
  ...
  WINDOW:SwitchTalk({PARTNER_0 = 1690175103, PARTNER_1 = 2107979582})
  WINDOW:DrawFace(20, 88, SymAct("PARTNER"), FACE_TYPE.NORMAL)
  WINDOW:SwitchTalk({PARTNER_0 = 853844473, PARTNER_1 = 738169016})
  WINDOW:SwitchTalk({PARTNER_0 = 13812603, PARTNER_1 = 432665146})
  WINDOW:CloseMessage()
...
function main10_daihyougayarareta01_end()
end
function subSaveflagM10_060_01()
  FLAG.SceneFlag = CONST.FL_SC_01_FIRST
  FLAG.SCENARIOFLAG = CONST.M10_DAIHYOUGAYARARETA_END
