function main14_aomidorinumatotsunyuu01_start()
  ...
  local __LB_SCOPE = function()
    ...
    function __scopeFuncTbl.CELECT_EVENT01()
      WINDOW:SysMsg(1661520605)
      local __labelCnt = 0
      local __labelTbl = {}
      WINDOW:SelectStart()
      WINDOW:SelectChain(2048129948, __labelCnt)
      __labelTbl[__labelCnt] = __scopeFuncTbl.LABEL_YES
      __labelCnt = __labelCnt + 1
      WINDOW:SelectChain(1363060831, __labelCnt)
