...
function main17_grepalaceeastyarareta01_init()
  if FLAG.NowResumeFlag == CONST.FLAG_TRUE then
    ...
    subSaveflagM17_040_01()
    SYSTEM:NextEntry(KEEP_PLACEMENT.ON)
  end
end
function main17_grepalaceeastyarareta01_start()
  subEveFromProgFadeSet()
  if FLAG.DunRestRet == CONST.FLAG_FALSE then
    subComSaveCompulFailed()
    subEveFadeAfterTime()
    WINDOW:DrawFace(20, 88, SymAct("PARTNER"), FACE_TYPE.PAIN)
    WINDOW:SwitchTalk({PARTNER_0 = 677780131, PARTNER_1 = 830286818})
    WINDOW:KeyWait()
  ...
  WINDOW:SwitchTalk({PARTNER_0 = 441481249, PARTNER_1 = 55265632})
  WINDOW:KeyWait()
  TASK:Regist(subEveDoubleJump, {
    CH("PARTNER")
  })
  WINDOW:DrawFace(20, 88, SymAct("PARTNER"), FACE_TYPE.NORMAL)
  WINDOW:SwitchTalk({PARTNER_0 = 1275781031, PARTNER_1 = 1427238630})
  WINDOW:SwitchTalk({PARTNER_0 = 2117909797, PARTNER_1 = 1730645092})
  WINDOW:CloseMessage()
  subEveNod(CH("HERO"))
...
function main17_grepalaceeastyarareta01_end()
end
function subSaveflagM17_040_01()
  FLAG.SceneFlag = CONST.FL_SC_01_FIRST
  FLAG.SCENARIOFLAG = CONST.M17_GREPALACEEASTYARARETA_END
