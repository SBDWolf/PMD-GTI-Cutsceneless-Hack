...
function main17_grepalaceeastboss1st01_start()
  ...
  CH("EMONGA"):SetPosition(SymPos("P02_5_EMONGA"))
  CH("BIRIJION"):SetPosition(SymPos("P02_5_BIRIJION"))
  CH("BIRIJION"):SetDir(SymPos("P03_BIRIJION"))
  CH("EMONGA"):SetDir(SymPos("P03_EMONGA"))
  CH("EMONGA"):SetPosition(SymPos("P03_EMONGA"))
