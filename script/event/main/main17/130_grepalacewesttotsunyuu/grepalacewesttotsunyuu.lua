...
function main17_grepalacewesttotsunyuu01_init()
end
function main17_grepalacewesttotsunyuu01_start()
  ...
  local __LB_SCOPE = function()
    ...
    function __scopeFuncTbl.CELECT_EVENT01()
      WINDOW:SysMsg(-2006849461)
      local __labelCnt = 0
      local __labelTbl = {}
      WINDOW:SelectStart()
      WINDOW:SelectChain(-1854220022, __labelCnt)
      __labelTbl[__labelCnt] = __scopeFuncTbl.LABEL_YES
      __labelCnt = __labelCnt + 1
      WINDOW:SelectChain(-1168667959, __labelCnt)
    ...
    function __scopeFuncTbl.LABEL_YES()
      ...
      FLAG.SCENARIOFLAG = CONST.M17_GREPALACEWESTTOTSUNYUU_END
      SYSTEM:ResetRescueCount()
      SYSTEM:IncAdventureCount()
      SYSTEM:EnterDungeon(Dg(21))
    end
...
function main17_grepalacewesttotsunyuu01_end()
end
function groundEnd()
end
