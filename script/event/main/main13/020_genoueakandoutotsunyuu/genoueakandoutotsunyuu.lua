function main13_genoueakandoutotsunyuu01_start()
  ...
  local __LB_SCOPE = function()
    ...
    function __scopeFuncTbl.CELECT_EVENT01()
      WINDOW:SysMsg(-1112547375)
      local __labelCnt = 0
      local __labelTbl = {}
      WINDOW:SelectStart()
      WINDOW:SelectChain(-1531646320, __labelCnt)
      __labelTbl[__labelCnt] = __scopeFuncTbl.LABEL_YES
      __labelCnt = __labelCnt + 1
      WINDOW:SelectChain(-1885749933, __labelCnt)
    ...
    function __scopeFuncTbl.LABEL_YES()
      ...
      FLAG.SCENARIOFLAG = CONST.M13_GENOUEAKANDOUTOTSUNYUU_END
      SYSTEM:ResetRescueCount()
      SYSTEM:IncAdventureCount()
      SYSTEM:EnterDungeon(Dg(12))
    end
