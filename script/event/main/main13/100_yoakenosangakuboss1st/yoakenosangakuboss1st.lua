...
function main13_yoakenosangakuboss1st01_start()
  ...
  CH("GIGAIASU_1"):SetPosition(SymPos("P00_GIGAIASU_1"))
  CH("SHANDERA_1"):SetPosition(SymPos("P00_SHANDERA_1"))
  CH("HERO"):SetDir(RotateTarget(0))
  CH("GIGAIASU_1"):SetDir(CH("HERO"))
  CH("SHANDERA_1"):SetDir(CH("HERO"))
