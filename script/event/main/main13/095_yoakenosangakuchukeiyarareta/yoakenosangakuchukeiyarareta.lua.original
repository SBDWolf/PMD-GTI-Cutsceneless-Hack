...
function main13_yoakenosangakuchukeiyarareta01_init()
  if FLAG.NowResumeFlag == CONST.FLAG_TRUE then
    ...
    subSaveflagM13_095_01()
    SYSTEM:NextEntry(KEEP_PLACEMENT.ON)
  end
end
function main13_yoakenosangakuchukeiyarareta01_start()
  subEveFromProgFadeSet()
  ...
  WINDOW:Monologue(-1644366253)
  WINDOW:Monologue(-2065185006)
  WINDOW:Monologue(-1345678127)
  WINDOW:CloseMessage()
...
function main13_yoakenosangakuchukeiyarareta01_end()
end
function subSaveflagM13_095_01()
  FLAG.SceneFlag = CONST.FL_SC_01_FIRST
  FLAG.SCENARIOFLAG = CONST.M13_YOAKENOSANGAKUCHUKEIYARARETA_END
