...
function main11_nanroyarareta01_init()
  if FLAG.NowResumeFlag == CONST.FLAG_TRUE then
    ...
    subSaveflagM11_030_01()
    SYSTEM:NextEntry(KEEP_PLACEMENT.ON)
  end
end
function main11_nanroyarareta01_start()
  subEveFromProgFadeSet()
  subComSaveCompulFailed()
  subEveFadeAfterTime()
  WINDOW:DrawFace(20, 88, SymAct("PARTNER"), FACE_TYPE.PAIN)
  WINDOW:SwitchTalk({PARTNER_0 = -1021864382, PARTNER_1 = -636705021})
  WINDOW:KeyWait()
  ...
  WINDOW:SwitchTalk({PARTNER_0 = -249432896, PARTNER_1 = -398801535})
  WINDOW:KeyWait()
  TASK:Regist(subEveJump, {
    CH("PARTNER")
  })
  WINDOW:DrawFace(20, 88, SymAct("PARTNER"), FACE_TYPE.NORMAL)
  WINDOW:SwitchTalk({PARTNER_0 = -1485089978, PARTNER_1 = -1100979705})
  WINDOW:CloseMessage()
  subEveNod(CH("HERO"))
...
function main11_nanroyarareta01_end()
end
function subSaveflagM11_030_01()
  FLAG.SceneFlag = CONST.FL_SC_01_FIRST
  FLAG.SCENARIOFLAG = CONST.M11_NANROYARARETA_END
